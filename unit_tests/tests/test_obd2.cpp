...
TEST_F(Obd2, ReadDtcsOne) {
	...
	EXPECT_CALL(
			...
			onTx(0x7E8,
				 ...
				 4,
				 0x43,
				 1, // len, service, DTC count (1)
				 0x01,
				 0x23, // First code: P0123
				 0,
				 0, // Second code: none
				 0	// Padding
				 ));
...
TEST_F(Obd2, ReadDtcsTwo) {
	...
	EXPECT_CALL(
			...
			onTx(0x7E8,
				 ...
				 6,
				 0x43,
				 2, // len, service, DTC count (1)
				 0x01,
				 0x23, // First code: P0123
				 0x06,
				 0x12, // Second code: P0612
				 0	   // Padding
				 ));
...

	{
		...
		EXPECT_CALL(
				...
				onTx(0x7E8,
					 8,
					 0x10,
					 0x08, // First frame, total length 8
					 0x43,
					 0x03, // service code, DTC count
					 0x01,
					 0x23, // First code P0123
					 0x06,
					 0x12 // Second code: P0612
...

	{
		...
		EXPECT_CALL(
				...
				onTx(0x7E8,
					 8,
					 0x10,
					 0x12, // First frame, total length 18
					 0x43,
					 0x08, // service code, DTC count
					 0x01,
					 0x23, // First code P0123
					 0x06,
					 0x12 // Second code: P0612
