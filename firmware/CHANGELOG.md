...
### Added
 ...
 - The VE table is now resizable from within TunerStudio: use "Adjust Table Size & Shape" to insert or delete rows and columns, or set a whole new shape. Either axis can be anywhere from 8 to 32 bins, for up to 1024 cells for a 32x32 table.
