...
void setTPS1Calibration(uint16_t tpsMin, uint16_t tpsMax, uint16_t tps1SecondaryMin, uint16_t tps1SecondaryMax) {
	...
	engineConfiguration->tpsSecondaryMonitors = false; // doesn't only monitor; averages sensors values
}
...
void setPPSCalibration(float primaryUp, float primaryDown, float secondaryUp, float secondaryDown) {
	...
	engineConfiguration->ppsSecondaryMonitors = false; // doesn't only monitor; averages sensors values
}
