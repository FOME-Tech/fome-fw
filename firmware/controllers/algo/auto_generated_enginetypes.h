...
constexpr inline const char* getCommand_x14_e(command_x14_e value) {
	switch (value) {
...
constexpr inline const char* getTs_command_e(ts_command_e value) {
	switch (value) {
