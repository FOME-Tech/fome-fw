...
const char * getBoardSpecificPinName(brain_pin_e brainPin) {
	switch(brainPin) {
		...
		case Gpio::B8: return "COP 6";
		case Gpio::B9: return "EECIV 36 Spark Out (SPOUT)";
		case Gpio::C13: return "COP 1";
		...
		case Gpio::E2: return "COP 5";
		case Gpio::E3: return "COP 4";
		case Gpio::E4: return "COP 3";
		case Gpio::E5: return "COP 2";
