...
static void setMapVeTable() {
	copyTableDynamic(config->veTable, config->veTableRows, config->veTableCols, hardCodedveTable);
	copyBinsDynamic(config->veLoadBins, config->veTableRows, hardCodedveLoadBins);
	copyBinsDynamic(config->veRpmBins, config->veTableCols, hardCodedveRpmBins);
}
