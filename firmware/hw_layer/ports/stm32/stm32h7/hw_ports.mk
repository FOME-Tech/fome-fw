...
HW_LAYER_EMS += $(HW_STM32_PORT_DIR)/stm32h7/flash/stm32h7xx_hal_flash.c \
				$(HW_STM32_PORT_DIR)/stm32h7/flash/stm32h7xx_hal_flash_ex.c

ALLINC += $(HW_STM32_PORT_DIR)/stm32h7/flash
