...
static const int8_t phaseA[] = {1, 1, -1, -1};

static const int8_t phaseB[] = {-1, 1, 1, -1};

static const int8_t microPhases[] = {0, 20,	 38,  56,  71,	83,	 92,  98,  100,	 98,  92,  83,	71,	 56,  38,  20,
...
static constexpr float phaseDutyCycleDivisor =
		1.0f / (100.0f * 100.0f); // both the phase degrees and duty cycle settings are in %
...
void DualHBridgeStepper::initialize(DcMotor* motorPhaseA, DcMotor* motorPhaseB, float reactionTime) {
	...
	efiAssertVoid(
			...
			engineConfiguration->stepperNumMicroSteps <= maxNumSteps,
