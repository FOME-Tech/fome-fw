...
1. In changelog.md, rename the "unreleased" section to "Month 20YY Release", copy the unreleased section in the comment to replace the renamed one, and commit the change to master.
...
1. Push the branch and tags: `git push && git push --tags`
