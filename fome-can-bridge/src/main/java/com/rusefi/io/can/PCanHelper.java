...
public class PCanHelper {
    ...
    public static TPCANStatus init(PCANBasic can) {
        return init(can, TPCANBaudrate.PCAN_BAUD_500K);
    }

    public static TPCANStatus init(PCANBasic can, TPCANBaudrate baudrate) {
        return can.Initialize(CHANNEL, baudrate, TPCANType.PCAN_TYPE_NONE, 0, (short) 0);
    }
