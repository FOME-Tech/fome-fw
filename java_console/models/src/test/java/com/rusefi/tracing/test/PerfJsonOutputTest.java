...
public class PerfJsonOutputTest {
    ...
    public void test() throws IOException {
        List<Entry> testEntries = Arrays.asList(
                new Entry("hello", Phase.B, 100, 0, 0),
                new Entry("hello2", Phase.B, 200, 0, 0),
                new Entry("hello2", Phase.E, 300, 0, 0),
                new Entry("hello", Phase.E, 400, 0, 0)
        );
