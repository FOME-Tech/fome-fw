...
public class TsOutputs {
	...
	public static final Field FUELPIDCORRECTION3 = Field.create("FUELPIDCORRECTION3", 242, FieldType.INT16).setScale(0.01).setBaseOffset(0);
	public static final Field FUELPIDCORRECTION4 = Field.create("FUELPIDCORRECTION4", 244, FieldType.INT16).setScale(0.01).setBaseOffset(0);
